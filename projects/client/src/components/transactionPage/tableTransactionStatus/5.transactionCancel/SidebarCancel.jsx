...
import TableDashboardPemesananCancel from './TableStatusCancel'

export default function SidebarPemesananCancel() {
  ...
  return (
    <div className="container mx-auto max-w-screen-lg">
      ...
      <div className="h-screen flex flex-col container mx-auto max-w-screen-lg mt-20">
        <div
          id="view"
          className="h-max w-full flex flex-col md:flex-row shadow-lg bg-white border border-neutral-200 max-md:mt-20"
        >
          <div
            id="sidebar"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <path d="M16.293 7.293a.999.999.999.999 0 0 0-1.414 0L12 10.586 9.121 7.707a.999.999.999.999 0 0 0-1.414 1.414L10.586 12l-2.879 2.879a.999.999.999.999 0 0 0 1.414 1.414L12 13.414l2.879 2.879a.997.997.997.997 0 0 0 1.414 0c.39-.39.39-1.024 0-1.414L13.414 12l2.879-2.879c.39-.39.39-.124 1.024 0-1.414z" />
                  </svg>
                  <span>Cancelled</span>
                </Link>
              </div>
