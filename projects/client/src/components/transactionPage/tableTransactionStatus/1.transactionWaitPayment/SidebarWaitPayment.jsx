...
import TableDashboardPemesananKonfirmasi from './TableStatusKonfirmasi'

export default function SidebarPemesananPaymentWaiting() {
      ...
      <div className="h-screen flex flex-col container mx-auto max-w-screen-lg mt-20">
        ...
        >
          ...
          <div className="flex-grow p-[10px]">
            <TableDashboardPemesananKonfirmasi />
          </div>
        </div>
        <Footer />
      </div>
